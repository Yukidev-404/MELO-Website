(() => {
  ...
  function exportCsv(rows){
    const headers=['Report ID','Status','Submitted','What Happened','How To Reproduce','Expected Result','Installation ID','Version','Build','Platform','OS','Proof Files'];
