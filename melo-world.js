(() => {
  ...
  document.addEventListener('keydown',e=>{if(e.key==='Enter'&&!boot.classList.contains('hide'))enter();if(e.key==='Escape')rooms.forEach(r=>r.classList.remove('open'));if(e.key===' '&&boot.classList.contains('hide')){e.preventDefault();togglePlayback()}});
